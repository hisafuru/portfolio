    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto mb-6">
        <Work
            ...
            description={`友人：沢井宇宙と設立した会社yosugaraで最初に取り組んだプロジェクト．産業用工作機械に取り付けたIoTにより機器の稼働状況を取得し，工場内に設置されたモニターやWebアプリ上から現在の稼働状況をリアルタイムに取得できる．
                        IoT基盤や筐体の設計から行い対象機器に最適化することで，"おじいちゃんでも設置できるIoT"を目指した．また，経営層からは状況が見えにくい夜間の工場の稼働状況を可視化することで，生産効率の向上や目標設定の改善を図った．`}
        ></Work>
        <Work
            imageUrl={Arcara}
        ...
        <Work
            ...
            description={`Airdrop（仮想通貨やトークンの無料配布イベントの総称）に関するポータルサイト.近年の仮想通貨プロジェクトでは，プロジェクト初期にコミットしてくれたユーザーに対し見返りとして仮想通貨やトークンを配布する"AirDrop"という仕組みが採用されていることが多い．
                仮想通貨やブロックチェーン技術の発展を促進するため，それらの情報や利用方法を提供するサイトを友人：沢井宇宙主導のもと作成した．`}
        ></Work>
        <Work
            imageUrl={Gameserver}
            title={'Game Server (仮)'}
